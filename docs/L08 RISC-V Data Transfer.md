...
permalink: /L08
nav_order: 8
description: "Lecture 8: RISC-V Data Transfer 在计算机系统中，存储数据和内存是基础知识。内存用于临时存储数据和指令，以便处理器快速访问和处理。这一部分内容为后续讨论打下了基础。"
...
![image-20240731142456297]({{ site.baseurl }}/docs/assets/image-20240731142456297.png)
...
![image-20240731142721682]({{ site.baseurl }}/docs/assets/image-20240731142721682.png)
...
![image-20240731142921591]({{ site.baseurl }}/docs/assets/image-20240731142921591.png)
